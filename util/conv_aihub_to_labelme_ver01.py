...
def create_labelme_file(labelme_path, object_list):
    ...
    width = 1920
    height = 1080
    template_path =r"D:\codestates\Section6\cp2\9bd11e123d5a574d\labelme_template.json"
    labelme_dict = common_util.load_json(template_path)    
...
if __name__ == "__main__":
    ...
    #BASE_FOLDER = r"D:\codestates\Section6\cp2\091\01.데이터\2.Validation\라벨링데이터\VL2\HY_현대\098_팰리세이드"
#    base_folders = r"D:\codestates\Section6\cp2\091\01.데이터\1.Training\라벨링데이터"
    ...
    base_output_folders_list = common_util.listdirs(base_output_folders,path_list=[])

    for i in range(len(base_folders_list)):
        print(i)
        BASE_FOLDER=base_folders_list[i]
